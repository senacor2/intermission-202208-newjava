...
(
    id          BIGINT AUTO_INCREMENT,
    acc_number  BIGINT       NOT NULL DEFAULT nextval('ACCOUNT_NUMBER'),
    uuid        UUID         NOT NULL,
...
ALTER TABLE ACCOUNT
    ADD CONSTRAINT UQ_ACCOUNT_NUMBER UNIQUE (acc_number);
ALTER TABLE ACCOUNT
...
ALTER TABLE TRANSACTION_STATUS
    ADD CONSTRAINT PK_TRANSACTION_STATUS PRIMARY KEY (name);
...
ALTER TABLE TRANSACTION
    ADD CONSTRAINT FK_TRANSACTION_ON_STATUS FOREIGN KEY (status)
        REFERENCES TRANSACTION_STATUS (name) ON DELETE CASCADE;
